...
function buildArticleCards(articles) {
  return articles.map(a => `
            <a href="/articles/${a.slug}.html" class="group block bg-white border border-gray-200 rounded-xl p-6 hover:border-amber-400 hover:shadow-lg transition-all duration-200">
                <h3 class="text-lg font-semibold text-gray-900 group-hover:text-amber-600 transition-colors leading-snug">${a.title}</h3>
                <p class="mt-3 text-sm text-gray-600 leading-relaxed line-clamp-3">${a.description}</p>
                <span class="inline-block mt-4 text-sm font-medium text-amber-600 group-hover:text-amber-700">Read article &rarr;</span>
            </a>`).join('\n');
}
    ...
    "@graph": [
      {
        ...
        "description": "AI-powered comic creation. Frameworks for acquiring, valuing, and monetizing undervalued organic traffic.",
        "publisher": { "@id": "https://comicstripai.com/#organization" }
      },
      {
        "@type": "Organization",
        "@id": "https://comicstripai.com/#organization",
        "name": "Comic Strip AI",
        "url": "https://comicstripai.com",
        "founder": {
          "@type": "Person",
...
<head>
    ...
    <title>Comic Strip AI — AI-powered comic creation</title>
...
<body class="bg-white text-gray-900 antialiased">
    ...
    <section class="bg-gradient-to-br from-emerald-600 via-emerald-700 to-emerald-900 text-white">
        <div class="max-w-5xl mx-auto px-6 py-24 md:py-32">
            ...
            <p class="mt-6 text-lg md:text-xl text-amber-100 max-w-2xl leading-relaxed">
            ...
            <div class="mt-10 flex flex-wrap gap-4">
                <a href="/articles.html" class="inline-block bg-white text-amber-700 font-semibold px-8 py-3 rounded-lg hover:bg-amber-50 transition-colors">Read the Playbooks</a>
                <a href="#about" class="inline-block border-2 border-amber-300 text-amber-100 font-semibold px-8 py-3 rounded-lg hover:bg-amber-800 transition-colors">Learn More</a>
            </div>
        </div>
    </section>
...
${cards}
    ...
    <section id="about" class="bg-gray-50 border-t border-gray-200">
        <div class="max-w-4xl mx-auto px-6 py-20">
            <h2 class="text-3xl font-bold text-gray-900">About Comic Strip AI</h2>
            <div class="mt-6 space-y-4 text-gray-700 leading-relaxed">
                <p>Comic Strip AI treats search traffic as a calculable asset class. Every keyword, domain, and content investment has a measurable spread between acquisition cost and monetization value. The frameworks here help operators identify, evaluate, and execute high-spread plays.</p>
                <p>Built by Victor Valentine Romo.</p>
                <p>Comic Strip AI is a Scale With Search property.</p>
            </div>
        </div>
    </section>
...
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Articles | Comic Strip AI</title>
    <meta name="description" content="Articles and guides covering ai-powered comic creation." />
    <link rel="canonical" href="https://comicstripai.com/articles.html" />
${ENTITY_LINKS}
    <script src="https://cdn.tailwindcss.com"></script>
    <script>
      tailwind.config = {
...
<body class="bg-white text-gray-900 antialiased">
    ...
    <nav class="border-b border-gray-200 bg-white sticky top-0 z-50">
        <div class="max-w-5xl mx-auto px-6 py-4 flex items-center justify-between">
            <a href="/" class="text-xl font-bold text-amber-600 hover:text-amber-700 transition-colors">Comic Strip AI</a>
            <div class="flex gap-6 text-sm font-medium text-gray-600">
                <a href="/articles.html" class="text-amber-600 font-semibold">Articles</a>
                <a href="/#about" class="hover:text-amber-600 transition-colors">About</a>
            </div>
        </div>
    </nav>
    ...
    <!-- Header -->
    <section class="bg-amber-600 text-white">
        <div class="max-w-5xl mx-auto px-6 py-16">
            <h1 class="text-3xl md:text-4xl font-bold">Latest Articles</h1>
            <p class="mt-4 text-amber-100 text-lg max-w-2xl">Tactical frameworks with real cost models and P&L data. Each article covers a key topic in depth.</p>
        </div>
    </section>
...
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Page Not Found | Comic Strip AI</title>
...
<body class="bg-white text-gray-900 antialiased">
    ...
    <main class="max-w-4xl mx-auto px-6 py-32 text-center">
        ...
        <a href="/" class="inline-block mt-8 bg-amber-600 text-white font-semibold px-8 py-3 rounded-lg hover:bg-amber-700 transition-colors">Back to Home</a>
    </main>
...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  <url>
    <loc>https://comicstripai.com/</loc>
    <lastmod>${today}</lastmod>
    <changefreq>weekly</changefreq>
    <priority>1.0</priority>
  </url>
  <url>
    <loc>https://comicstripai.com/articles.html</loc>
    <lastmod>${today}</lastmod>
    <changefreq>weekly</changefreq>
  ...
  for (const a of articles) {
    xml += `
  <url>
    <loc>https://comicstripai.com/articles/${a.slug}.html</loc>
...
Sitemap: https://comicstripai.com/sitemap.xml
`;
...
// Main
function main() {
  console.log('Building comicstripai.com...\n');
